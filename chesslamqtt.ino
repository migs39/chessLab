...
// input pins
const int geradaColuna0  = 22; //1   
const int geradaColuna1 =  17; //2
const int geradaColuna2 =  21; //3
const int geradaFileira0  = 19; //4
const int geradaFileira1  = 20; //5    
const int geradaFileira2  = 14; //6 
const int subirJogada  = 10; //7
const int acertoujogada  = 4; //16

// output pins
const int jogadaColuna0  = 13; //8    
const int jogadaColuna1 =  11; //9  
const int jogadaColuna2 =  12; //10
const int jogadaFileira0  = 9; //11
const int jogadaFileira1  = 6; //12    
const int jogadaFileira2  = 7; //13
const int inicar  = 5;    //14
const int fim  = 16; //15
